        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                @role('ADMIN')
                    ...
                    <li class="">
                        <a href="{{ route('managebill') }}" class="svg-icon">
                            <i class="fas fa-file svg-icon"></i>
                            <span class="ml-4">Manage Bills</span>
                        </a>
                    </li>
                ...
                @role('USER')
                    ...
                    <li class="">
                        <a href="{{ route('createbill') }}" class="svg-icon">
                            <i class="fa fa-file" aria-hidden="true"></i>
                            <span class="ml-4">Upload Bill</span>
                        </a>
                    </li>
                @endrole
                ...
                <li class="">
                    <a href="{{ route('billstatus') }}" class="svg-icon">
                        <i class="fa fa-file" aria-hidden="true"></i>
                        <span class="ml-4">Bill Status</span>
                    </a>
                </li>
